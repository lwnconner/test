...
public class Order {
	...
	private String orderNum;// 订单号-- 随机生成

	@Column(name = "C_TELEPHONE")
	private String telephone; // 来电号码---快递员电话

	@Column(name = "C_CUSTOMER_ID")
	private Integer customer_id; // 客户编号---客户id
	...
	private Area sendArea; // 寄件人省市区信息 ----发件区域地址(需编辑)
	...
	private Area recArea; // 收件人省市区信息--收件区域地址(需编辑)
	...
	// 分单类型 1 自动分单 2 人工分单------分单类型(业务层编写)
	@Column(name = "C_ORDER_TYPE")
	private String orderType;

	// 订单状态 1 待取件 2 运输中 3 已签收 4 异常---货物状态(业务层编写)
